<script>
	...
	async function login() {
		const url = `http://127.0.0.1:8000/jobSeeker/auth/${encodeURIComponent(loginData.email)}/${encodeURIComponent(loginData.password)}`;
...
<div class="min-h-screen flex items-center justify-center">
	<div class="rounded-lg shadow-md bg-rich-black form-width form-padding">
		...
		<p class="mt-4 text-sm col-baby-powder text-center">
			...
			<a href="/jsregister" class="underline">Sign Up</a> !
		</p>
	</div>
</div>
